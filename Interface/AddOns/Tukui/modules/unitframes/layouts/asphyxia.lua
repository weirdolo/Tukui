...
local function Shared(self, unit)
	...
	if (unit == "player" or unit == "target") then
		...
		power:Width(246)
		if unit == "player" then
			power:Point("TOP", health, "BOTTOM", 0, -6)
		...
		Name:SetFont(C.media.pixelfont, C["datatext"].fontsize)
		...
		if (C["unitframes"].charportrait == true) then
			...
			portrait:SetAlpha(1)
			if unit == "player" then
				portrait:SetPoint("TOP", health, "BOTTOM", 0, -17)
			elseif unit == "target" then
				portrait:SetPoint("TOP", health, "BOTTOM", 0, -17)
			end
		...
		if (C["unitframes"].unitcastbar == true) then
			...
			elseif unit == "target" then
				...
				castbar:SetHeight(20)
				castbar:Point("TOPRIGHT", self, "BOTTOMRIGHT", 0, 17)
			end
